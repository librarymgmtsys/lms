...
return [
    ...
    'books'                              => [
        'title'          => 'Books',
        'title_singular' => 'Book',
        'book_issue_count'=> 'Total times book issued',
        'book_issue_count_current'=> 'Currently Issued Copies',
        'book_issue_count'=> 'Total times book issued',
        'books_under_fine'=>'Books under fine period',
        'fields'         => [
            ...
            'copies'                 => 'Copies',
            'copies_helper'          => '',
            'default_issue_days'                 => 'Issue for days (default)',
            'default_issue_days_helper'          => '',
            'fine'                 => 'Fine',
            'fine_helper'          => 'Fine will be automatically charged on book receiving',
            'available_copies'                 => 'Available Copies',
            'available_copies_helper'          => '',
            'publication_year'                 => 'Publication Year',
            'publication_year_helper'          => '',
            'author'                 => 'Author',
            'author_helper'          => '',
            'remarks' => 'Description',
            'remarks_helper' => '',
        ...
        'issue_book' => "Issue Books",
        'receive_book' => "Receive Books",
    ],
    'issue'                              => [
        'title'          => 'Issue Book',
        ...
        'fields'         => [
            ...
            'issue_date_from_helper' => '',
            'issue_date_to'=> 'To',
            'issue_date_to_helper' => '',
            'remarks_at_issue' => 'Remarks on Issue',
            'remarks_at_issue_helper' => '',
            'created_at'         => 'Created At',
            'created_at_helper'  => '',
            'updated_at'         => 'Updated At',
            'updated_at_helper'  => '',
    ...
    'receive'                              => [
        ...
        'fields'         => [
            ...
            'remarks_at_receive' => 'Remarks on Receive',
            'remarks_at_receive_helper' => '',
            'created_at'         => 'Added At',
            'created_at_helper'  => '',
            'updated_at'         => 'Updated At',
            'updated_at_helper'  => '',
    ...
    'books_issue'                              => [
        'title'          => 'Book Issue',
        'title_singular' => 'Book Issue',
        'fields'         => [
            'book_id'=>'Book',
            'book_id_issue_helper' => '',
            'user_id'=>'User',
            'user_id_issue_helper' => '',
            'issued_by'=>'Issued By',
            'issued_by_issue_helper' => '',
            'issue_date_from'=> 'From',
            'issue_date_from_issue_helper' => '',
            'issue_date_to'=> 'To',
            'issue_date_to_issue_helper' => '',
            'remarks_at_issue' => 'Remarks on Issue',
            'remarks_at_issue_helper' => '',
            'created_at'         => 'Created At',
            'created_at_helper'  => '',
    ...
    'admin_dash' => [
        'reports_all_books' => "Books In Library",
        'reports_current_issued' => "Books Issued",
        'reports_total_issued' => "Books Issued Till Today",
        'reports_total_fine_received' => "Fine Received",
        'reports_total_fine_pending' => "Fine To Be Receieved",
        'reports_today_receive_books' => "Books To Be Received Today",
        'reports_last_10_fines'=>"Last 10 Fines",
        'reports_last_10_issue'=>"Last 10 Issue",
        'reports_last_10_receive'=>"Last 10 Submits"
    ],

    'user_dash' => [
        'user_current_issued' => "Books Issued",
        'user_total_issued' => "Books Issued Till Today",
        'user_total_fine_received' => "Fine",
        'user_total_fine_pending' => "Fine To Be Paid",
        'user_today_receive_books' => "Books To Be Submitted Today",
    ],
    'books_management' => [
        'title'=>"My Book Managment",
        'my_books'=> "My Books",
        'submit_today'=> "Submit Today",
        'under_fine'=> "Under Fine",
        'my_fine'=>"My Fines",
