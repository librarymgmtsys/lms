            ...
            <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
                ...
                <form class="form-inline ml-0 ml-md-3">
                    <div class="input-group input-group-sm">
                        <input class="form-control form-control-navbar" name="q" value="{{request('q')}}" type="search"
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/login"><i class="fas fa-user"></i> &nbsp;
                        {{auth()->getUser()? ''.auth()->getUser()->name:'Login'}} </a>
                </li>
            </ul>
        </div>
    </nav>

    <div class="content-wrapper" style="height: 100vh; margin-left:0px">
            ...
            <div class="container">
                        ...
                        <div class="bg-white p-5 rounded shadow">
                                        ...
                                        <div class="input-group-append">
                                            ...
                                            <a href="/">
                                                <button id="button-addon1" type="button"
                                                    class="btn btn1 btn-link text-primary"><i
                                                        class="fa fa-times-circle"></i></button>
                                            </a>

                                            <button id="button-addon1" type="submit"
                                                class="btn btn1 btn-link text-primary"><i class="fa fa-search"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                            ...
                            <table class="table mb-5 table-borderless">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th scope="row">{{$i}}</th>
                                        <td>{{$item->lms_book_id}}</td>
                                        <td>{{$item->name}}</td>
                                        <td>{{$item->isbn}}</td>
                                        <td>{{$item->langId->name}}</td>
                                        <td>{{$item->categoryId->name}}</td>
                                        <td>{{$item->author}}</td>
                                        <td>{{$item->publication_year}}</td>
                                        <td>{{$item->available_copies>0?'Yes':'No'}}</td>
                                    </tr>
                            ...
                            @elseif(!empty(request('q')) && count($books)<=0) Sorry, Nothing Found. @endif </div> </div>
                                </div> <!-- /.row -->
                        </div><!-- /.container-fluid -->
                    </div>
                    <!-- /.content -->
                    ...
                    <div class="content">
                        <div class="container">
                            <div class="card-columns">
                                @foreach($accouncements as $item)
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title">
                                            {{\Carbon\Carbon::parse($item->created_at)->format("d/m/Y")}}</h5>
                                        <hr />
                ...
                <script>
                    ...
                    ! function (e, t) {
                        ...
                        "use strict";
                        var i, t, o, n, r, a, s, c, f, l, u, d, h, p, _, g, y, m, v, C, D, E, A, O, w, b, L, S, j,
                            T, I, Q, R,
                            ...
                            oe = (i = jQuery, t = "ControlSidebar", o = "lte.control.sidebar", n = i.fn[t], r =
                                ...
                                "control-sidebar-open", f = "control-sidebar-slide-open", l = {
                                    ...
                                    return n.prototype.show = function () {
                                        ...
                                        this._setMargin(), i("body").hasClass(c) || i("body").hasClass(f) ? this
                                            .show() :
                                            this.collapse()
                                        ...
                                        return this.each(function () {
                                            var e = i(this).data(o);
                                            if (e || (e = new n(this, i(this).data()), i(this).data(o,
                                                    e)),
                                                "undefined" === e[t]) throw new Error(t +
                                                " is not a function");
                                            e[t]()
                                        })
                                    }, n
                                ...
                                }), i.fn[t] = u._jQueryInterface, i.fn[t].Constructor = u, i.fn[t].noConflict =
                                function () {
                                    return i.fn[t] = n, u._jQueryInterface
                                }, u),
                            re = (d = jQuery, h = "Layout", p = "lte.layout", _ = d.fn[h], g = ".main-sidebar", y =
                                ".main-header", m = ".content-wrapper", v = ".main-footer", C = "hold-transition",
                                D =
                                function () {
                                    function n(e) {
                                    ...
                                    return n.prototype.fixLayoutHeight = function () {
                                        var e = {
                                            ...
                                            t = this._max(e);
                                        d(m).css("min-height", t - e.header), d(g).css("min-height", t - e
                                            .header)
                                ...
                                }), d.fn[h] = D._jQueryInterface, d.fn[h].Constructor = D, d.fn[h].noConflict =
                                function () {
                            ...
                            ae = (E = jQuery, A = "PushMenu", w = "." + (O = "lte.pushmenu"), b = E.fn[A], L = {
                                    ...
                                    function n(e, t) {
                                        ie(this, n), this._element = e, this._options = E.extend({}, S, t), E(j
                                                .OVERLAY)
                                    ...
                                    return n.prototype.show = function () {
                                        ...
                                        (E(window).width() >= this._options.screenCollapseSize ? !E(j.BODY)
                                            .hasClass(T) : E(
                                ...
                                }), E.fn[A] = Q._jQueryInterface, E.fn[A].Constructor = Q, E.fn[A].noConflict =
                                function () {
                            ...
                            se = (R = jQuery, P = "Treeview", B = "." + (x = "lte.treeview"), M = R.fn[P], k = {
                                    ...
                                    return i.prototype.init = function () {
                                        ...
                                        e.slideUp(this._config.animationSpeed, function () {
                                            t.removeClass(V), R(n._element).trigger(i), e.find(Y +
                                                    " > " + N)
                                        ...
                                        return this.each(function () {
                                            ...
                                            e || (e = new i(R(this), t), R(this).data(x, e)), "init" ===
                                                n && e[n]()
                                        })
                                    }, i
                                ...
                                }), R.fn[P] = W._jQueryInterface, R.fn[P].Constructor = W, R.fn[P].noConflict =
                                function () {
                            ...
                            ce = (X = jQuery, z = "Widget", q = "." + (F = "lte.widget"), J = X.fn[z], K = {
                                    ...
                                    function n(e, t) {
                                        ie(this, n), this._element = e, this._parent = e.parents(Z.CARD).first(),
                                            this
                                            ._settings = X.extend({}, ee, t)
                                    }
                                    return n.prototype.collapse = function () {
                                        var e = this;
                                        this._parent.children(Z.CARD_BODY + ", " + Z.CARD_FOOTER).slideUp(this
                                            ._settings
                                            .animationSpeed,
                                            function () {
                                                e._parent.addClass($)
                                        ...
                                        var e = this;
                                        this._parent.children(Z.CARD_BODY + ", " + Z.CARD_FOOTER).slideDown(this
                                            ._settings
                                            .animationSpeed,
                                            function () {
                                        ...
                                        var t = this;
                                        this._parent = e, X(this).find(this._settings.collapseTrigger).click(
                                            function () {
                                                t.toggle()
                                            }), X(this).find(this._settings.removeTrigger).click(
                                            function () {
                                                t.remove()
                                            })
                                    }, n._jQueryInterface = function (t) {
                                        return this.each(function () {
                                            var e = X(this).data(F);
                                            e || (e = new n(X(this), e), X(this).data(F, "string" ==
                                                    typeof t ? e :
                                                    t)), "string" == typeof t && t.match(
                                                    /remove|toggle/) ? e[t]() :
                                                "object" === ("undefined" == typeof t ? "undefined" :
                                                    ne(t)) && e
                                                ._init(X(this))
                                        })
                                    }, n
                                ...
                                }), X.fn[z] = te._jQueryInterface, X.fn[z].Constructor = te, X.fn[z].noConflict =
                                function () {
                                    return X.fn[z] = J, te._jQueryInterface
                                }, te);
                        e.ControlSidebar = oe, e.Layout = re, e.PushMenu = ae, e.Treeview = se, e.Widget = ce,
                            Object
