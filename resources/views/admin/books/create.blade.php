...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('global.books.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form action="{{ route("admin.books.store") }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('lang_id') ? 'has-error' : '' }}">
                ...
                <select class="custom-select" id="lang_id" name="lang_id" class="form-control" value="{{ old('lang_id', isset($product) ? $product->lang_id : '') }}">
                    @foreach ($languages as $item)
                    <option  {{old('lang_id', isset($product) ? $product->lang_id : '')==$item->id?'selected':''}} value="{{$item->id}}">{{$item->name}}</option>
                    @endforeach
                  </select>
            ...
            <div class="form-group {{ $errors->has('category_id') ? 'has-error' : '' }}">
                ...
                <select class="custom-select" id="category_id" name="category_id" class="form-control" value="{{ old('category_id', isset($product) ? $product->category_id : '') }}">
                    @foreach ($categories as $item)
                    <option  {{old('category_id', isset($product) ? $product->category_id : '')==$item->id?'selected':''}} value="{{$item->id}}">{{$item->name}}</option>
                    @endforeach
                  </select>
            ...
            <div class="form-group {{ $errors->has('isbn') ? 'has-error' : '' }}">
                ...
                <input type="text" id="isbn" name="isbn" class="form-control" value="{{ old('isbn', isset($product) ? $product->isbn : '') }}">
                @if($errors->has('isbn'))
                    <p class="help-block">
                        {{ $errors->first('isbn') }}
                    </p>
            ...
            <div class="form-group {{ $errors->has('copies') ? 'has-error' : '' }}">
                ...
                <input type="text" id="copies" name="copies" class="form-control" value="{{ old('copies', isset($product) ? $product->copies : '') }}">
            ...
            <div class="form-group {{ $errors->has('default_issue_days') ? 'has-error' : '' }}">
                ...
                <input type="text" id="default_issue_days" name="default_issue_days" class="form-control" value="{{ old('default_issue_days', isset($product) ? $product->default_issue_days : '') }}">
            ...
            <div class="form-group {{ $errors->has('publication_year') ? 'has-error' : '' }}">
                ...
                <input type="text" id="publication_year" name="publication_year" class="form-control" value="{{ old('publication_year', isset($product) ? $product->publication_year : '') }}">
            ...
            <div class="form-group {{ $errors->has('author') ? 'has-error' : '' }}">
                ...
                <input type="text" id="author" name="author" class="form-control" value="{{ old('author', isset($product) ? $product->author : '') }}">
